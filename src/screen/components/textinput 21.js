...
export default class Textinput extends Component {
  constructor(props) {
    super(props);
    this.state = { bordercolor: props.error && props.error.length>0?'red':'black', elevation: 0, borderWidth: 0 };
  }
      ...
      >
        ...
        <View style={styles.buttonStyle}>
          {this.props.value.length > 0 ? (
            ...
            >
              <Icons name={'clear'} color={this.props.error && this.props.error.length>0?'red':'green'} size={20} />
            </TouchableWithoutFeedback>
          ) : (
            <View />
          )}
